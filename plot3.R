...
legend("topright", legend = names(dat)[7:9] , col = c("black" , "red" , "blue") , lty = 1  , cex = 0.8  , y.intersp = 0.5 , x.intersp = 0.5 )

dev.copy(png,'..\\Downloads\\ExData_Plotting1-master\\ExData_Plotting1-master\\plot3.png',  width = 480, height = 480)
dev.off()